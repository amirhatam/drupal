...
class SvgSanitizerFormatterTest extends KernelTestBase {
   ...
   */
  protected function getPreparedFieldOutput($filepath, array $settings) {
   ...
   */
  public function testSanitizer($filepath, array $settings, array $expect_removed, array $expect_present) {
    $output = $this->getPreparedFieldOutput(DRUPAL_ROOT . $filepath, $settings);
   ...
   *   Test cases.
   */
  public function providerSanitizer() {
    return [
      'defaults' => [
        '/vendor/enshrined/svg-sanitize/tests/data/svgTestOne.svg',
        [
          'type' => 'svg_sanitizer',
          'settings' => [
            'allowedattrs' => '',
